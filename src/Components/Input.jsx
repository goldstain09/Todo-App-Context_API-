  ...
  return (
    <div>
      <div
        className={
          emptyError
            ? "Input_Div_forError d-flex align-content-center"
            : "Input_Div d-flex align-content-center"
        }
      >
        <input
        ...
        />
        <button onClick={addInputData} className="Add_btn">
          <i
            className={
              cntxt.Edit_is ? "bi bi-journal-arrow-up" : "bi bi-plus-square"
            }
          ></i>
        </button>
      </div>
